    ...
    <View style={styles.container}>
      ...
      <View style={styles.menuContainer}>
        <TouchableOpacity
          ...
          <MaterialCommunityIcons name="menu" color="#006a36" size={30} />
        </TouchableOpacity>
      </View>
        ...
        <ScrollView
          ...
          <View style={styles.outerContainer}>
            <View style={styles.innerContainer}>
              <Entypo name="language" size={40} color={'#006a36'} />
            ...
            {showLanguageOptions && (
              <RadioButton.Group
                ...
                <View
                  ...
                  <RadioButton color="#006a36" value="en" />
                  <Text
                    style={{
                      marginLeft: 10,
                      fontFamily: 'serif',
                ...
                <View
                  ...
                  <RadioButton color="#006a36" value="hi" />
                  <Text
                    style={{
                      marginLeft: 10,
                      fontFamily: 'serif',
